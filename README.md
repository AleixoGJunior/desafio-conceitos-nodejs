# Desafio 2 - Conceitos de Node.js
O objetivo do desafio é criar um aplicação para treinar os conhecimentos aprendidos sobre Node.js.

## Sobre
Deve-se criar uma aplicação para armazenar repositórios do seu portifólio, que permita criação, listagem, alteração e remoção dos repositórios, além de permitr que os repositórios recebam likes.
...
Esse projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/AleixoGJunior/desafio-conceitos-nodejs/blob/master/LICENSE) para mais detalhes.
